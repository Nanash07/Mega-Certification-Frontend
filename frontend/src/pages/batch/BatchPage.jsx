    ...
    fetchCertificationRules()
      .then((rules) => {
        const sorted = [...rules].sort((a, b) => {
          const keyA = `${a.certificationCode || ""} ${
            a.certificationLevelName || ""
          } ${a.subFieldCode || ""}`.toLowerCase();
          const keyB = `${b.certificationCode || ""} ${
            b.certificationLevelName || ""
          } ${b.subFieldCode || ""}`.toLowerCase();
                ...
                <tr key={b.id}>
                  ...
                  <td className="flex gap-2">
                    ...
                    <button
                      ...
                      onClick={() =>
                        setConfirmDelete({ open: true, id: b.id })
                      }
                    >
                      Hapus
                    </button>
