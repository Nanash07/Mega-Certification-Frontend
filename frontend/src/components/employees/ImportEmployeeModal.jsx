        ...
        {result && (
          <div className="mt-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm mt-2">
              ...
              <div>Created: <b className="text-green-600">{result.created}</b></div>
              <div>Updated: <b className="text-blue-600">{result.updated}</b></div>
              <div>Mutated: <b className="text-purple-600">{result.mutated}</b></div>
              <div>Resigned: <b className="text-red-600">{result.resigned}</b></div>
              <div>Errors: <b className="text-orange-600">{result.errors}</b></div>
            </div>
